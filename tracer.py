...
def show(r):
    ...
    if 'location' in r:
        loc = r['location']
        print('')
        print(f"  {BOLD}{YELLOW}*** LOCATION FOUND ***{RESET}")
        ...
        print('')
        print(f"  {BOLD}{YELLOW}*** LOCATION FOUND (from text) ***{RESET}")
        print(f"  {YELLOW}Location{RESET}  : {r['text_location']}")
    elif 'server_location' in r:
        srv = r['server_location']
        print('')
        print(f"  {BOLD}{MAGENTA}*** SERVER LOCATION ***{RESET}")
        print(f"  {DIM}(Approximate - from hosting server){RESET}")
        print(f"  {MAGENTA}Server IP{RESET}   : {srv.get('server_ip', 'N/A')}")
        print(f"  {MAGENTA}City{RESET}       : {srv.get('server_city', 'N/A')}")
        print(f"  {MAGENTA}Region{RESET}     : {srv.get('server_region', 'N/A')}")
        print(f"  {MAGENTA}Country{RESET}    : {srv.get('server_country', 'N/A')}")
        if 'server_org' in srv:
            print(f"  {MAGENTA}Organization{RESET}: {srv['server_org']}")
        if 'server_isp' in srv:
            print(f"  {MAGENTA}ISP{RESET}       : {srv['server_isp']}")
        print(f"  {MAGENTA}Maps{RESET}       : {srv.get('server_maps', 'N/A')}")
    else:
        print('')
